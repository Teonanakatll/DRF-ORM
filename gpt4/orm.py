...
n = BookG.objects.values('product').annotate(total_price=Sum(F('quantity') * F('product__price')))
...
# двух джоинов к модели books для подсчета рейтинго и доновременно для послёта самой books
